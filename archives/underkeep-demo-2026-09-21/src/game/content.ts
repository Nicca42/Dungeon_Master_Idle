...
export const RESEARCH: Research[] = [
  {
    ...
    description:
      '25% shorter spawn intervals, +20 adventurer capacity, and party formation reduced from 20 to 15 real seconds.',
    cost: 3000,
    hours: 4,
    icon: 'staff',
  },
  ...
  },
  {
    ...
    description:
      'Medium · Double staff movement speed and speed up maintenance work. Trap resets use staff speed plus intelligence against trap difficulty.',
    cost: 1500,
    hours: 4,
    icon: 'staff',
  },
